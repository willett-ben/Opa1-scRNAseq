...
#double check cell cycle and clusters:
#0 = naive (G1 and Lef1 expression)
#1 = activated, dividing
#2 = activated, G1
#3 = activated, dividing, uniquely Opa1 cells
...
Hallmark_Myc_targets_v1 <- mapIds(org.Mm.eg.db, Mm.h$HALLMARK_MYC_TARGETS_V1, 'SYMBOL', 'ENTREZID')
Hallmark_Myc_targets_v2 <- mapIds(org.Mm.eg.db, Mm.h$HALLMARK_MYC_TARGETS_V2, 'SYMBOL', 'ENTREZID')
...
#         Supp Figure 5E (to do)
```{r moduel score}

```

#         Figures for the paper - cNMF analysis
          6I-J
```{r include = TRUE, echo = TRUE}
